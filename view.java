...
public class view extends JFrame {
	...
	public view() {
		...
		txtNh.setForeground(Color.RED);
		txtNh.setBackground(Color.YELLOW);
		txtNh.setHorizontalAlignment(SwingConstants.CENTER);
		txtNh.setFont(new Font("Times New Roman", Font.PLAIN, 14));
		txtNh.setEditable(false);
		txtNh.setText("Student infomation");
		txtNh.setBounds(230, 9, 158, 20);
		...
		txtStudentid.setBounds(10, 131, 80, 20);
		...
		txtMajor.setBounds(10, 158, 80, 20);
		...
		txtEnrolldate.setBounds(10, 188, 80, 20);
		...
		dateenrolldate.setBounds(100, 184, 158, 20);
		...
		addbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {///add button
			}
		});
		...
		addbutton.setBounds(324, 184, 105, 23);
		...
		btnSaveAs.setBounds(346, 494, 105, 23);
		...
		btnResetButton.addActionListener(new ActionListener() {		
			public void actionPerformed(ActionEvent e) {
				...
				tfstudentid.setText("");
				tfmajor.setText("");
				dateenrolldate.setCalendar(null);
										
			}
		});
		
		btnResetButton.setBounds(439, 184, 113, 23);
